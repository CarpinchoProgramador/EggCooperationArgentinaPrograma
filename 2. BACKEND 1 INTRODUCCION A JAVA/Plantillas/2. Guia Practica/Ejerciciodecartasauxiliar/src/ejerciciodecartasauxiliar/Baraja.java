package ejerciciodecartasauxiliar;
        ...
        if (cantCartass > baraja.size()) {
            ...
            for (int i = 0; i < cantCartass; i++) {
                for (Carta auxd : baraja) {
                    System.out.println(baraja.get(i).getNumero() + " de " + baraja.get(i).getPalo());
    ...
    public void cartasMonton() {
        ...
        for (Carta cartaM : barajaMonton) {
            if (barajaMonton.isEmpty()) {
                ...
                System.out.println(cartaM.getNumero() + " de " + cartaM.getPalo());
            }
        }
    }
